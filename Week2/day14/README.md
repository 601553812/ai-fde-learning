...
```text
.\.venv\Scripts\python.exe -m pytest Week2/day14/test_day14.py -q --tb=short
```

完成后再跑 Day 13～14 回归（检查今天是否影响昨天）：

```text
.\.venv\Scripts\python.exe -m pytest Week2/day13/test_day13.py Week2/day14/test_day14.py -q --tb=short
```
...
curl.exe -i -H "Content-Type: application/json" --data-binary "@Week2/day14/sample_request.json" http://127.0.0.1:8014/analyze-requirement
