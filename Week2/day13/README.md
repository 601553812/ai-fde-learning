...
```text
.\.venv\Scripts\python.exe -m pytest Week2/day13/test_day13.py -q --tb=short
```

准备验收时再运行回归：

```text
.\.venv\Scripts\python.exe -m pytest Week2/day11/test_day11.py Week2/day12/test_day12.py Week2/day13/test_day13.py -q --tb=short
```
...
.\.venv\Scripts\python.exe -m uvicorn Week2.day13.app:app --host 127.0.0.1 --port 8013
```
...
curl.exe -i -H "Content-Type: application/json" --data-binary "@Week2/day13/sample_request.json" http://127.0.0.1:8013/analyze-requirement
